    ...
    return (
        <div className="w-full flex items-center gap-1 mt-[30px] overflow-hidden font-raleway font-[700]">
            <button
                ...
                className={`${type === "CsvHDFSSourceSettings" ? "bg-secondary" : "bg-primary opacity-30"
                    } hover:bg-secondary hover:opacity-100 transition-all ease-in-out duration-200 
      rounded-[10px]  min-w-[70px] md:min-w-[88px]
      ...
      px-[12px] md:px-[20px] text-xsmall xl:text-small 2xl:text-default `}
            ...
            <button
                ...
                className={`${type === "JsonHDFSSourceSettings" ? "bg-secondary" : "bg-primary opacity-30"
                    } hover:bg-secondary hover:opacity-100 transition-all ease-in-out duration-200 
      rounded-[10px] min-w-[70px] md:min-w-[88px]
      border-2 border-secondary cursor-pointer h-[36px] md:h-[42px]
      px-[12px] md:px-[26px] text-xsmall xl:text-small 2xl:text-default`}
            ...
            <button
                ...
                className={`${type === "XmlHDFSSourceSettings" ? "bg-secondary" : "bg-primary opacity-30"
                    } hover:bg-secondary hover:opacity-100 transition-all ease-in-out duration-200 
     rounded-[10px] min-w-[70px] md:min-w-[88px]
      border-2 border-secondary cursor-pointer h-[36px] md:h-[42px]
      px-[12px] md:px-[26px] text-xsmall xl:text-small 2xl:text-default`}
            ...
            <button
                ...
                className={`${type === "ClickHouseSourceSettings" ? "bg-secondary" : "bg-primary opacity-30"
                    } hover:bg-secondary hover:opacity-100 transition-all ease-in-out duration-200 
      rounded-[10px] min-w-[70px] md:min-w-[88px]
      border-2 border-secondary cursor-pointer h-[36px] md:h-[42px]
      px-[12px] md:px-[26px] text-xsmall xl:text-small 2xl:text-default`}
            ...
            <button
                ...
                className={`${type === "PostgreSQLSourceSettings" ? "bg-secondary" : "bg-primary opacity-30"
                    } hover:bg-secondary hover:opacity-100 transition-all ease-in-out duration-200 
      rounded-[10px] min-w-[70px] md:min-w-[88px]
      border-2 border-secondary cursor-pointer h-[36px] md:h-[42px]
      px-[12px] md:px-[26px] text-xsmall xl:text-small 2xl:text-default`}
